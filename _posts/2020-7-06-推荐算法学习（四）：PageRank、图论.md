...
常用的社区发现算法有LPA（基于标签传播的非重叠社区发现算法）和COPRA（基于LPA的扩展算法，用于重叠社区发现算法）。LPA算法的步骤是：
...
LPA算法示意：<img src="https://raw.githubusercontent.com/Alice1214/alice1214.github.io/master/_posts/image/推荐算法（四）/9.png" alt="0" style="zoom:70%;" />
